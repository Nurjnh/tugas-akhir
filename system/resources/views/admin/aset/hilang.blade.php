    ...
    <div class="col-md-4">
        <div class="card text-white">
            <div class="card-body bg-warning ">
                <h1 class="text-white">Aset Hilang</h1>
                <h1 class="text-white float-right">{{$asetHilang}} Unit</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{url('admin/aset',$item->aset_id)}}/detail" class="btn btn-dark"><i class="fa fa-eye"></i> Detail Aset</a></td>
