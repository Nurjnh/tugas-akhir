                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required  name="unit_pemegang[]" value="{{$item->unit_pemegang}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="unit_kode[]" value="{{$item->unit_kode}}">
                                </div>
                            </div>
                        </div> 
                        @endforeach
